...
<div class="layui-container">
  ...
  <div class="hot-sell">
    ...
    <div class="layui-row layui-col-space20">
      <a href="detail.html" class="layui-col-xs3 text">
        <div><img src="img/home_img4.jpg"></div>
        <p>一盏好看的台灯</p>
        <p class="price">￥200</p>
      </a>
      <a href="detail.html" class="layui-col-xs3 text">
        <div><img src="img/home_img5.jpg"></div>
        <p>时尚瓷碗7件套</p>
        <p class="price">￥200</p>
      </a>
      <a href="detail.html" class="layui-col-xs3 text">
        <div><img src="img/home_img6.jpg"></div>
        <p>智能电吹风</p>
        <p class="price">￥200</p>
      </a>
      <a href="detail.html" class="layui-col-xs3 text">
        <div><img src="img/home_img7.jpg"></div>
        <p>一盏好看的台灯</p>
        <p class="price">￥200</p>
      </a>
    </div>
  ...
  <div class="hot-sell">
    ...
    <div class="layui-row layui-col-space20">
      <a href="detail.html" class="layui-col-xs3 text">
        <div><img src="img/home_img8.jpg"></div>
        <p>蒂芙尼蓝化妆刷</p>
        <p class="price">￥200</p>
      </a>
      <a href="detail.html" class="layui-col-xs3 text">
        <div><img src="img/home_img9.jpg"></div>
        <p>玻璃洗漱三件套</p>
        <p class="price">￥200</p>
      </a>
      <a href="detail.html" class="layui-col-xs3 text">
        <div><img src="img/home_img10.jpg"></div>
        <p>清洁力强劲浴球</p>
        <p class="price">￥200</p>
      </a>
      <a href="detail.html" class="layui-col-xs3 text">
        <div><img src="img/home_img11.jpg"></div>
        <p>瘦脸仪</p>
        <p class="price">￥200</p>
      </a>
    </div>
...
<div class="layui-container">
  <div class="hot-sell">
    ...
    <div class="layui-row layui-col-space20">
      <a href="detail.html" class="layui-col-xs3 text">
        <div><img src="img/home_img12.jpg"></div>
        <p>森系小清新四件套</p>
        <p class="price">￥200</p>
      </a>
      <a href="detail.html" class="layui-col-xs3 text">
        <div><img src="img/home_img13.jpg"></div>
        <p>森系小清新四件套</p>
        <p class="price">￥200</p>
      </a>
      <a href="detail.html" class="layui-col-xs3 text">
        <div><img src="img/home_img14.jpg"></div>
        <p>森系小清新四件套</p>
        <p class="price">￥200</p>
      </a>
      <a href="detail.html" class="layui-col-xs3 text">
        <div><img src="img/home_img15.jpg"></div>
        <p>森系小清新四件套</p>
        <p class="price">￥200</p>
      </a>
      <a href="detail.html" class="layui-col-xs3 text">
...
<div class="layui-fulid" id="champ">
  <div class="layui-row">
    <a href="list.html" class="layui-col-xs3">
      <img src="img/home_img16.jpg">
    </a>
    <a href="list.html" class="layui-col-xs6">
      <img src="img/home_img17.jpg">
    </a>
    <a href="list.html" class="layui-col-xs3">
      <img src="img/home_img20.jpg">
    </a>
    <a href="list.html" class="layui-col-xs3">
      <img src="img/home_img18.jpg">
    </a>
    <a href="list.html" class="layui-col-xs3">
      <img src="img/home_img19.jpg">
    </a>
    <a href="list.html" class="layui-col-xs3">
      <img src="img/home_img21.jpg">
    </a>
  </div> 
</div>
