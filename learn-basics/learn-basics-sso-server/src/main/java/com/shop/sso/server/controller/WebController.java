package com.shop.sso.server.controller;

import com.shop.sso.server.feign.SsoLoginService;
...
public class WebController extends BaseWebController {
    @Autowired
    private SsoLoginService memberServiceFeign;
    @RequestMapping("/")
    ...
    public String doLogin(HttpServletRequest request,
        ...
        UserLoginInpDTO userLoginInpDTO = new UserLoginInpDTO().setMobile(username).setPassword(password).setDeviceInfor("苹果").setLoginType("PC");
