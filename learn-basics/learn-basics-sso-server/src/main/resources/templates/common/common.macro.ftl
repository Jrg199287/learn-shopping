...
<#macro commonHeader>
    <header class="main-header">
        <a href="${request.contextPath}/" class="logo">
            ...
            <span class="logo-lg"><b>统一登录平台</b></span>
        </a>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="nav-click <#if pageName == "help">active</#if>" ><a href="${request.contextPath}/"><i class="fa fa-circle-o text-gray"></i><span>登录入口</span></a></li>
            </ul>
        </section>
        <!-- /.sidebar -->
    </aside>
...
<#macro commonFooter >
    <footer class="main-footer">
        Powered by <b>统一登录平台</b> 1.1.1-SNAPSHOT
