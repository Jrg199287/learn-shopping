package com.mayikt.impl.pay.service.callback.template.alipay;

import com.alipay.api.AlipayApiException;
import com.alipay.api.internal.util.AlipaySignature;
import com.alipay.demo.trade.config.AlipayConfig;
...
public class AliPayCallbackTemplate extends AbstractPayCallbackTemplate {
	...
	public Map<String, String> verifySignature(HttpServletRequest req, HttpServletResponse resp) {
		...
		LogUtil.writeLog("BackRcvResponse接收后台通知开始"+resp.toString());
		...
		reqParam.remove("sign_type");
		boolean alipayRSACheckedV2 = false;
		try {
			alipayRSACheckedV2 = AlipaySignature.rsaCheckV2(reqParam, AlipayConfig.alipay_public_key,"utf-8", AlipayConfig.sign_type);
	...
	public String asyncService(Map<String, String> verifySignature) {
		...
		TransactionEntity paymentTransaction = paymentTransactionMapper.selectByPaymentId(orderId);
