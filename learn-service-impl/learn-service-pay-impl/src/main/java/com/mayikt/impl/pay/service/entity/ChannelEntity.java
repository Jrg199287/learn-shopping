package com.mayikt.impl.pay.service.entity;
...
public class ChannelEntity implements Serializable {
    ...
    @TableField("RETRY_BEANID")
    private String retryBeanId;

    public String getRetryBeanId() {
        return retryBeanId;
    }

    public void setRetryBeanId(String retryBeanId) {
        this.retryBeanId = retryBeanId;
    }
