...
import com.mayikt.api.spike.SpikeCommodityService;
import com.mayikt.impl.spike.service.producer.SpikeCommodityProducer;
import com.mayikt.impl.spike.service.service.mapper.SeckillMapper;
import com.mayikt.impl.spike.service.service.mapper.entity.SeckillEntity;
...
public class SpikeCommodityServiceImpl extends BaseApiService<JSONObject> implements SpikeCommodityService {
	...
	public BaseResponse<JSONObject> spike(String phone, Long seckillId) {
		...
		//基于redis的超卖解决方案
//		Boolean result = redisUtil.setNx(phone,seckillId+"", (long) 10);
//		if (!result) {
